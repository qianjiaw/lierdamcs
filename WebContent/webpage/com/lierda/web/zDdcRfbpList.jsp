...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zDdcRfbpList" title="ddc园区关联表" actionUrl="zDdcRfbpController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="ddcid" field="ddcid"   width="120"></t:dgCol>
   <t:dgCol title="房间id" field="roomname"   width="120"></t:dgCol>
   <t:dgCol title="房间id" field="floorname"   width="120"></t:dgCol>
   <t:dgCol title="建筑物id" field="buildingname"   width="120"></t:dgCol>
   <t:dgCol title="园区id" field="parkname"   width="120"></t:dgCol>
