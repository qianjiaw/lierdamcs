			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div class="page-content">
						<div class="row" style="position:relative;height: 100%;width: 100%;">
							<div class="col-xs-12" style="width: 100%;height:100%;margin-left:0px;padding-right: 0px;" id="tabs">
	...
	<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
		...
		<script>
			...
			function setHAndWonload () {
				////////////////////////////////setheight
				setHeight("body", "main-container", 50);
				setHeight("main-container", "tab-content", 45);
			}
